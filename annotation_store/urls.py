...
urlpatterns = [
    ...
    url( r'^api/delete/(?P<annotation_id>[0-9a-z:+-_]+|)$', views.delete, name="api_delete"),
    url( r'^api/destroy/(?P<annotation_id>[0-9a-z:+-_]+|)$', views.delete, name="api_delete"),
    url( r'^api/update/(?P<annotation_id>[0-9a-z:+-_]+)$', views.update, name="api_update"),
