...
class TOD_Implementation(TODAPI_LTI):
    ...
    @staticmethod
    def get_dict_of_files_from_courses(user_requesting, courses):
        files_in_courses = dict()
        for course_item in courses:
            files_found = TOD_Implementation.get_own_targets_from_course(user_requesting, course_item.course_id)
