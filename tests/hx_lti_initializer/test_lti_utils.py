...
from hx_lti_initializer.utils import DashboardAnnotations, _fetch_annotations_by_course
...
def test_fetch_annotations_by_course_success_new_highlighter():
    ...
    with requests_mock.Mocker() as requests_mocker:
        ...
        r = _fetch_annotations_by_course(
            context_id, annotation_db_url, annotator_auth_token
        )
